...
class Review(TypedDict):
    ...
    pros : Annotated[Optional[list[str]], 'Returns the pros']
    cons : Annotated[Optional[list[str]], 'Returns the cons']
    important_points : Annotated[list[str], 'Returns list of key points, discussed in a list']
    summary : Annotated[str, 'Returns summary of the content.']
    sentiment : Annotated[str, 'Returns sentiment of the content.']
